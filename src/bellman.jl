...
function solve_bellman!(value_old, value_new, policy, policies_full, a_grid, z_MC, converged; maxiter=100, tol = √eps())
  
  for i in 1:maxiter
    iterate_bellman!(value_new, value_old, policy, policies_full, a_grid, z_MC, converged)
...
function solve_bellman(a_grid, z_MC, proto_policy; maxiter=200, tol=√eps())
  ...
  solve_bellman!(value_old, value_new, policy, policies_full, a_grid, z_MC, converged; maxiter=maxiter, tol=tol)
