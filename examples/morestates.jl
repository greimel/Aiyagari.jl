...
@time out11 = solve_bellman(endo1, exo1, agg_state11, param, Owner(Aiyagari.Unconditional(), Aiyagari.NoState()), rtol=√eps())
#0.43 s (49 it)
@time out21 = solve_bellman(endo2, exo1, agg_state21, param, Owner(Aiyagari.Unconditional(), Aiyagari.IsState()), rtol=√eps())
#4.85 s (49 it)
@time out12 = solve_bellman(endo1, exo2, agg_state12, param, Owner(Aiyagari.Unconditional(), Aiyagari.NoState()), rtol=√eps())
#1.03 s (49 it)
